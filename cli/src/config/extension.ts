...
export const EXTENSIONS_DIRECTORY_NAME = path.join('.recoder', 'extensions');
export const EXTENSIONS_CONFIG_FILENAME = 'recoder-extension.json';
export const EXTENSIONS_CONFIG_FILENAME_OLD = 'qwen-extension.json';
export const INSTALL_METADATA_FILENAME = '.recoder-extension-install.json';
...
export class ExtensionStorage {
  ...
  static async createTmpDir(): Promise<string> {
    return await fs.promises.mkdtemp(path.join(os.tmpdir(), 'recoder-extension'));
  }
}
...
export async function installExtension(
  ...
  try {
    ...
    // ~/.recoder/extensions/{ExtensionConfig.name}.
