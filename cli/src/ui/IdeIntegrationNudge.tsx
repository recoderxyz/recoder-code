...
import { type DetectedIde, getIdeInfo } from 'recoder-code-core';
...
export function IdeIntegrationNudge({
  ...
  const isExtensionPreInstalled =
    !!process.env['RECODER_CODE_IDE_SERVER_PORT'] &&
    !!process.env['RECODER_CODE_IDE_WORKSPACE_PATH'];
    ...
    >
      <Box marginBottom={1} flexDirection="column">
        <Text>
          ...
          {`Do you want to connect ${ideName ?? 'your editor'} to Recoder Code?`}
        </Text>
