...
import type { EditorType, Config, IdeContext } from 'recoder-code-core';
import {
  ApprovalMode,
    ...
    addItem(
      {
        ...
        text: 'Refreshing hierarchical memory (RECODER.md or other context files)...',
      },
      Date.now(),
    );
    try {
  ...
  const getAvailableModelsForCurrentAuth = useCallback((): AvailableModel[] => {
    ...
    switch (contentGeneratorConfig.authType) {
      case AuthType.QWEN_OAUTH:
        return getFilteredRecoderModels(visionModelPreviewEnabled);
