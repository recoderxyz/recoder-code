                ...
                case 'dialog':
                  switch (result.dialog) {
                    ...
                    case 'subagent_list':
                      ...
                      return { type: 'handled' };
                    case 'api-key-setup':
                      console.log('🔍 [PROCESSOR] api-key-setup case - need openApiKeySetupDialog function');
                      // TODO: Wire up openApiKeySetupDialog when integrated into App.tsx
                      return { type: 'handled' };
                    case 'recoder-login':
                      console.log('🔍 [PROCESSOR] recoder-login case - need openRecoderLoginDialog function');
                      // TODO: Wire up openRecoderLoginDialog when integrated into App.tsx
                      return { type: 'handled' };
                    case 'help':
                      return { type: 'handled' };
                    default: {
